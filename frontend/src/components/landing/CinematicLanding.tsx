        ...
        <div className="cinematic-app-window cinematic-shell">
          ...
          <div className="cinematic-app-body">
            ...
            <div className="cinematic-register-panel">
              ...
              <div className="cinematic-availability" aria-live="polite"><span><i aria-hidden="true" /><b>{fullName}</b><small>visual example · availability not checked</small></span><strong>{annualPrice} USDC <small>/ year · indicative</small></strong></div>
