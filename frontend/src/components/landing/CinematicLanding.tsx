    ...
    <div className="arcns-cinematic" id="top">
      ...
      <section className="cinematic-hero cinematic-shell" aria-labelledby="landing-title">
        <div className="cinematic-hero-copy">
          <p className="cinematic-eyebrow"><span aria-hidden="true" />Independent naming protocol built on Arc</p>
          <h1 id="landing-title">One name.<br /><em>Every interaction.</em></h1>
          <p className="cinematic-lede">Turn a wallet address into a human-readable identity on Arc. Explore FlashNames, then search, register, and resolve names in the application.</p>
          <p className="cinematic-disclosure">FlashNames is independent and is not affiliated with, sponsored by, or endorsed by Circle or the Arc team.</p>
          <div className="cinematic-actions">
            <Link className="cinematic-primary-button" href="/app">Visit FlashNames <Arrow /></Link>
        ...
        <div className="cinematic-identity-visual" aria-hidden="true">
          ...
          <div className="cinematic-identity-core"><span className="cinematic-core-pulse" /><Image src="/flashnames/flashnames-emblem.svg" alt="" width={180} height={180} priority /></div>
          ...
          <div className="cinematic-chip cinematic-chip-resolve"><small>PROTOCOL</small><b>Built on Arc</b></div>
        </div>
      </section>

      <section className="cinematic-experience" id="experience" aria-labelledby="experience-title">
        <div className="cinematic-section-heading cinematic-shell"><div><span>01</span><p>Interactive experience</p></div><h2 id="experience-title">Claim your place<br />on Arc.</h2><p>Explore the full registration flow with a safe, simulated transaction. No wallet or funds required.</p></div>
        <div className="cinematic-app-window cinematic-shell">
          <div className="cinematic-app-topbar"><div className="cinematic-mini-brand"><Image src="/flashnames/flashnames-emblem.svg" alt="" width={32} height={32} />Flash<span>Names</span></div><div className="cinematic-network-pill"><i aria-hidden="true" />Built on Arc</div><Link className="cinematic-demo-connect" href="/app">Connect</Link></div>
      ...
      <section className="cinematic-identity cinematic-shell" id="identity" aria-labelledby="identity-title">
        ...
        <div className="cinematic-feature-grid">
          ...
          <article><span aria-hidden="true">OPEN</span><p>Forward and reverse resolution</p><h3>Use the application to configure and inspect name records on Arc.</h3></article>
        </div>
      </section>
      ...
      <section className="cinematic-how" id="how" aria-labelledby="how-title"><div className="cinematic-shell">
        ...
        <div className="cinematic-steps"><article><b>01</b><span aria-hidden="true">FIND</span><h3>Find a name</h3><p>Search the application for an available <code>.arc</code> or <code>.circle</code> name.</p></article><article><b>02</b><span aria-hidden="true">SET</span><h3>Register onchain</h3><p>Review the verified in-app quote and confirm the registration flow.</p></article><article><b>03</b><span aria-hidden="true">OK</span><h3>Resolve it</h3><p>Inspect ownership and configure supported records using FlashNames application tools.</p></article></div>
        <div className="cinematic-closing"><div><Image src="/flashnames/flashnames-emblem.svg" alt="" width={100} height={100} /><h2>Make yourself<br /><em>recognizable.</em></h2></div><Link className="cinematic-primary-button cinematic-pale-button" href="/app">Launch App <Arrow /></Link></div>
        <nav className="cinematic-resource-links" id="resources" aria-label="FlashNames resources"><Link href="/app">Search names</Link><Link href="/send">Send assets</Link><Link href="/resolve">Resolve</Link><Link href="/developers/integrate">Integrate FlashNames</Link><Link href="/terms">Terms</Link><Link href="/privacy">Privacy</Link><Link href="/trademark">Trademark</Link></nav>
      </div></section>
    </div>
  );
}
