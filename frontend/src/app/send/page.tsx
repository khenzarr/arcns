    ...
    <main className="relative min-h-[calc(100vh-64px)] overflow-hidden px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      ...
      <div className="relative mx-auto grid w-full max-w-[1180px] gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
        <section className="pt-4 lg:sticky lg:top-28">
          <p className="mb-4 text-xs font-bold uppercase tracking-[0.2em] text-[var(--arcns-cyan)]">ArcNS payments utility</p>
          ...
          <p className="mt-6 max-w-xl text-lg leading-8 text-[var(--arcns-text-secondary)]">
            Transfer assets from your connected wallet to any valid address, <code>.arc</code> name, or <code>.circle</code> name. ArcNS resolves the receiving address before your wallet asks you to sign.
          </p>

          <div className="mt-8 grid gap-3 sm:grid-cols-3 lg:grid-cols-1">
            {[
              ["01", "Resolve", "See the exact destination behind every ArcNS name."],
          ...
          <p className="mt-6 max-w-lg text-xs leading-5 text-[var(--arcns-text-muted)]">
            ArcNS never takes custody and does not route funds through an ArcNS contract. Circle asset names and contract addresses are shown for discovery; this independent interface is not Circle-sponsored or endorsed.
          </p>
        </section>
